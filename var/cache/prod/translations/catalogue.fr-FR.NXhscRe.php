...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'Select reference' => 'Sélectionnez la référence',
    'optional' => 'optionnel',
    ...
    'Don\'t forget to save your customization to be able to add to cart' => 'N\'oubliez pas d\'enregistrer votre personnalisation pour pouvoir ajouter au panier',
  ...
  array (
    ...
    'Remove' => 'Retirer',
    'remove from cart' => 'retirer du chariot',
    'Show' => 'Montrer',
    'Hide' => 'Cacher',
    'Previous' => 'Précédent',
    'Next' => 'Suivant',
    ...
    'Reorder' => 'Réorganiser',
    'Print out' => 'Imprimer',
    'Send reset link' => 'Envoyer le lien de remise à zéro',
  ...
  array (
    ...
    'brands' => 'marques',
    '%s other product in the same category:' => '%s autre produit dans la même catégorie:',
    '%s other products in the same category:' => '%s autres produits de la même catégorie:',
    'Customers who bought this product also bought:' => 'Les clients qui ont acheté ce produit ont également acheté:',
    'My alerts' => 'Mes alertes',
    ...
    'New products' => 'Nouveaux produits',
    'All new products' => 'Tous les nouveaux produits',
    '1 person is currently watching this product.' => '1 personne regarde actuellement ce produit.',
    '%nb_people% people are currently watching this product.' => '%nb_people% les gens regardent actuellement ce produit.',
    ...
    'No RSS feed added' => 'Aucun flux RSS ajouté',
    'On sale' => 'En soldes',
    'All sale products' => 'Tous les produits de vente',
    'All suppliers' => 'Tous les fournisseurs',
    'Suppliers' => 'Fournisseurs',
    'No supplier' => 'Aucun fournisseur',
    'Viewed products' => 'Produits vus',
    ...
    'Save %percentage%' => 'Sauvegarder %percentage%',
    'Save %amount%' => 'Sauvegarder %amount%',
    '%price% tax excl.' => '%price% hors taxes.',
    'Instead of %price%' => 'Au lieu de %price%',
    'Including %amount% for ecotax' => 'Comprenant %amount% pour l\'écotaxe',
    '(not impacted by the discount)' => '(non compris dans la réduction)',
    '(%unit_price%)' => '(%unit_price%)',
    'No tax' => 'Aucune taxe',
    ': ' => ' :',
    'There are %product_count% products.' => 'Il y a %product_count% des produits.',
    'There is 1 product.' => 'Il y a 1 produit.',
    'List of products by brand %brand_name%' => 'Liste des produits par marque %brand_name%',
  ...
  array (
    ...
    'Product successfully added to your shopping cart' => 'Produit ajouté avec succès à votre panier',
    'Quantity:' => 'Quantité:',
    'There are %products_count% items in your cart.' => 'Il y a %products_count% article dans votre panier.',
    'There is %product_count% item in your cart.' => 'Il y a %product_count% articles dans votre panier.',
    ...
    'Use this address for invoice too' => 'Utilisez également cette adresse pour la facture',
    'Gift' => 'Cadeau',
    ...
    'Create an account' => 'Créer un compte',
    '(optional)' => '(optionnel)',
    'And save time on your next order!' => 'Et économisez du temps sur votre prochaine commande!',
    ...
    'Shipping Address' => 'Adresse de livraison',
    'The selected address will be used as your personal address (for invoice).' => 'L\'adresse sélectionnée sera utilisée comme adresse personnelle (pour la facture).',
    'Billing address differs from shipping address' => 'L\'adresse de facturation diffère de l\'adresse de livraison',
    'Your Invoice Address' => 'Votre adresse de facture',
    'The selected address will be used both as your personal address (for invoice) and as your delivery address.' => 'L\'adresse sélectionnée sera utilisée à la fois comme adresse personnelle (pour facture) et comme adresse de livraison.',
    'Transaction amount has been correctly updated' => 'Le montant de la transaction a correctement été mis à jour',
    'By confirming the order, you certify that you have read and agree with all of the conditions below:' => 'En confirmant la commande, vous certifiez avoir lu et accepté toutes les conditions ci-dessous:',
    'Selected' => 'Choisi',
    'Unfortunately, there are no payment method available.' => 'Malheureusement, il n\'y a pas de méthode de paiement disponible.',
    'Please make sure you\'ve chosen a [1]payment method[/1] and accepted the [2]terms and conditions[/2].' => 'Assurez-vous d\'avoir choisi un [1]mode de paiement[/1] et a accepté le [2]termes et conditions[/2].',
    'No payment needed for this order' => 'Aucun paiement nécessaire pour cet ordre',
    'Order with an obligation to pay' => 'Commande avec obligation de paiement',
    'Place order' => 'Commander',
    'If you sign out now, your cart will be emptied.' => 'Si vous vous déconnectez, votre panier sera vidé.',
    ...
    'Unfortunately, there are no carriers available for your delivery address.' => 'Malheureusement, il n\'y a pas de transporteurs disponibles pour votre adresse de livraison.',
    'If you would like to add a comment about your order, please write it in the field below.' => 'Si vous souhaitez ajouter un commentaire sur votre commande, écrivez-la dans le champ ci-dessous.',
    'Shopping Cart' => 'Panier d\'achat',
    'Your order is confirmed' => 'Votre commande est confirmée',
    'An email has been sent to your mail address %email%.' => 'Un courriel a été envoyé à votre adresse mail %email%.',
    'You can also [1]download your invoice[/1]' => 'Vous pouvez aussi [1]téléchargez votre facture[/1]',
    'Order details' => 'Détails de la commande',
    'Save time on your next order, sign up now' => 'Gagnez du temps sur votre prochaine commande, inscrivez-vous maintenant',
    'Order reference: %reference%' => 'Référence de l\'achat: %reference%',
    'Payment method: %method%' => 'Mode de paiement: %method%',
    'Shipping method: %method%' => 'Méthode d\'envoi: %method%',
    'Code' => 'Code',
    'Description' => 'La description',
    'Value' => 'Valeur',
    'Minimum' => 'Le minimum',
  ...
  array (
    ...
    'Not you? [1]Log out[/1]' => 'Pas toi? [1]Se déconnecter[/1]',
    ...
    'If you wish to return one or more products, please mark the corresponding boxes and provide an explanation for the return. When complete, click the button below.' => 'Si vous souhaitez renvoyer un ou plusieurs produits, marquez les cases correspondantes et expliquez le retour. Une fois terminé, cliquez sur le bouton ci-dessous.',
    ...
    'Guest Order Tracking' => 'Suivi des commandes des clients',
    'To track your order, please enter the following information:' => 'Pour suivre votre commande, entrez les informations suivantes:',
    'For example: QIIXJXNUI or QIIXJXNUI#1' => 'Par exemple: QIIXJXNUI ou QIIXJXNUI#1',
    'Guest Tracking' => 'Suivi des clients',
    'Transform your guest account into a customer account and enjoy:' => 'Transformez votre compte invité en compte client et profitez:',
    ...
    'Here are the orders you\'ve placed since your account was created.' => 'Voici les commandes que vous avez placées depuis la création de votre compte..',
    'Details' => 'Détails',
    'Your personal information' => 'Vos informations personnelles',
    'Vouchers' => 'Pièces justificatives',
    'Credit slips' => 'Relevés de crédit',
    'Addresses' => 'Adresses',
    'Add first address' => 'Ajouter la première adresse',
    'Information' => 'Information',
    'Order history and details' => 'Historique des commandes et détails',
    ...
    'You have given permission to receive your order in recycled packaging.' => 'Vous avez autorisé à recevoir votre commande dans des emballages recyclés.',
    'You have requested gift wrapping for this order.' => 'Vous avez demandé un emballage cadeau pour cette commande.',
    'Message' => 'Message',
    'Follow your order\'s status step-by-step' => 'Suivez le statut de votre commande étape par étape',
    ...
    'Reminder' => 'Rappel',
    'All merchandise must be returned in its original packaging and in its original state.' => 'Toutes les marchandises doivent être retournées dans leur emballage d\'origine et dans leur état d\'origine.',
    'Please print out the [1]returns form[/1] and include it with your package.' => 'Veuillez imprimer le [1]formulaire de retour[/1] et l\'inclure avec votre colis.',
    'Please check the [1]returns form[/1] for the correct address.' => 'S\'il vous plaît, vérifiez le [1]formulaire de retour[/1] pour l\'adresse correcte.',
    'When we receive your package, we will notify you by email. We will then begin processing order reimbursement.' => 'Lorsque nous recevrons votre colis, nous vous en informerons par courrier électronique. Nous commencerons alors à traiter le remboursement de la commande.',
    'Please let us know if you have any questions.' => 'Veuillez nous informer si vous avez des questions.',
    ...
    'Credit slips you have received after canceled orders.' => 'Les jetons de crédit que vous avez reçus après les commandes annulées..',
    'Credit slip' => 'Bulletin de crédit',
    'View credit slip' => 'Voir fiche de crédit',
    'Please enter the email address you used to register. You will receive a temporary link to reset your password.' => 'Entrez l\'adresse électronique que vous avez utilisée pour vous inscrire. Vous recevrez un lien temporaire pour réinitialiser votre mot de passe.',
    'Forgot your password?' => 'Mot de passe oublié?',
  ...
  array (
    ...
    'Store information' => 'Informations sur les magasins',
    'Call us: [1]%phone%[/1]' => 'Appelez-nous: [1]%phone%[/1]',
    'Fax: [1]%fax%[/1]' => 'Faxer: [1]%fax%[/1]',
    'Email us: [1]%email%[/1]' => 'Écrivez-nous: [1]%email%[/1]',
    'Currency:' => 'Devise:',
    'Currency dropdown' => 'Menu déroulant devise',
    'Get our latest news and special sales' => 'Recevez nos offres spéciales',
    'Carousel buttons' => 'Boutons de carrousel',
    'Previous' => 'Previous',
    'Next' => 'Suivant',
    'Carousel container' => 'Conteneur carrousel',
    'Language:' => 'La langue:',
    'Language dropdown' => 'Menu déroulant devise',
    '%label%:' => '%label% :',
    'Close' => 'Fermer',
    ...
    'Search again what you are looking for' => 'Rechercher de nouveau ce que vous cherchez',
    ...
    'You cannot access this store from your country. We apologize for the inconvenience.' => 'Vous ne pouvez pas accéder à ce magasin de votre pays. Nous nous excusons pour le dérangement.',
    'Panel Tool' => 'Outil de panneau',
    'Layout Mod' => 'Modes de mise en page',
    'Theme' => 'Thème',
    'Default' => 'Défaut',
    ...
    'Compare' => 'Comparer',
    'Account' => 'Compte',
    'Sorry, We are updating data, please come back later!!!!' => 'Désolé, nous mettons à jour les données, reviens plus tard !!!!',
    'Childrens' => 'Enfants',
    'Recent blog posts' => 'Articles récents sur le blog',
    'Posted By' => 'Posté par',
    'Comment' => 'Commentaire',
    'Comments' => 'Commentaires',
    'Created On' => 'Créé sur',
    'Comment Link' => 'Lien de commentaire',
    ...
    'Sorry, This blog is not avariable. May be this was unpublished or deleted.' => 'Désolé, ce blog n\'est pas avariable. Peut-être que cela n\'a pas été publié ou supprimé.',
